...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_OA_MEETING = new String[]{"oameeting_model", "OAMEETING_MODEL"};
	public static final String[] PD_MATERIAL_MATERIALPROC = new String[]{"materialProc", "MATERIAL_PROC"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
