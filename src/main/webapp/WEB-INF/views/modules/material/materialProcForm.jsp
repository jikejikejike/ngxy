...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/material/materialProc/form?id=${materialProc.id}">物资申请<shiro:hasPermission name="material:materialProc:edit">${not empty materialProc.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="material:materialProc:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="materialProc" action="${ctx}/material/materialProc/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="material:materialProc:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
